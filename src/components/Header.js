      ...
      <header id="home">
        ...
        <div className="row banner">
          <div className="banner-text">
            <h1 className="responsive-headline" style={{ marginTop: "-100px" }}> Steven Hernandez </h1>
            <img src="./images/profilepic.jpg" style={{ margin: "15px", boxShadow: "5px 5px 10px rgba(0, 0, 0, .5)" }} alt="Profile Picture" className="profile-pic"></img>
            <h3>
